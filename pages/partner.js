...
// import { peacockBlue, white2, black } from 'utils/colors'
...
//   background: ${p => p.blue && peacockBlue};
//   font-size: ${rem(11)};
//   opacity: ${p => !p.blue && 0.5};
//   color: ${p => p.blue && white2};
//   width: ${p => p.blue && rem(36)};
//   height: ${rem(15)};
//   margin: 0 auto ${rem(7.5)} 0;
//   text-align: center;

//   ${media.mobile`
//     font-size: ${rem(15)};
//     width: ${p => p.blue && rem(55.5)};
//     height: ${rem(24.1)};
//   `}
// `
...
//   /*
//     TODO:
//     const, state, store(redux)는 각기 어떤 용도를 가지는 지 생각해보세요
//     위 세가지는 '데이터를 저장하고 있는 그릇이다'라고 생각해보고
//     1. const로 선언하는 변수는 고정입니까 가변적입니까
//     2. state의 특징은 무엇입니까
//     3. state와 store의 차이는 무엇입니까
//   */
//   state = {
//     partners: [
...
//       { id: 2, name: '베이컨 박스', contents: '정기선물 배송서비스', benefit: '첫 구매 시 30% 할인', url: 'https://www.baconbox.co/', logo: '/static/images/logo/membership_baconboxlogo.png' },
...
//       { id: 4, name: '닥터 케이', contents: '건국대학교 수의대 사료', benefit: '구매 시 30% 할인', url: 'https://goo.gl/Fic9Dg', logo: '/static/images/logo/membership_doctorklogo.png' },
...
//       { id: 7, name: '핏펫', contents: '반려동물 Lifeware', benefit: '펫시팅 시 20% 할인', url: 'http://fitpet.co.kr/', logo: '/static/images/logo/membership_fitpetlogo2.png' },
...
//       { id: 11, name: '펫프렌즈', contents: '반려견 용품구매', benefit: '첫 구매시 20%, 이후 3~5%할인(무료배송)', url: 'http://www.pet-friends.co.kr/', logo: '/static/images/logo/membership_petfriendslogo.png' },
//       { id: 12, name: '펫미업', contents: '반려동물 셔틀버스', benefit: '첫 이용 시 2,000원 할인', url: 'https://www.petmeup.co.kr/', logo: '/static/images/logo/membership_petmeuplogo.png' },
