...
const SlideWrapper = styled.div`
  ...
  @keyframes slide-in {
    100% { transform: translateX(${p => p.translateValue}%); }
  }

  @-webkit-keyframes slide-in {
    100% { -webkit-transform: translateX(${p => p.translateValue}%); }
  }
    
  @keyframes slide-out {
    0% { transform: translateX(${p => p.translateValue}%); }
    100% { transform: translateX(${p => p.translateValue - 100}%); }
  }

  @-webkit-keyframes slide-out {
    0% { -webkit-transform: translateX(${p => p.translateValue}%); }
    100% { -webkit-transform: translateX(${p => p.translateValue - 100}%); }
  }
`
